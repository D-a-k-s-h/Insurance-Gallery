    ...
    <div className='w-full h-full overflow-auto'>
        <div className='w-full h-full flex flex-col gap-10 justify-center'>
            ...
            <div className='w-full flex flex-col gap-1 justify-center'>
                <p className='text-2xl font-mono'>Renewal Export Report</p>
                <p className='flex flex-row gap-2 items-center font-mono'><TbReportAnalytics className='text-blue-50 text-lg' /> <span className='text-blue-50'>Export</span>/ Renewal Export Report</p> 
            </div>

            {/* HEADING 2*/}
            <div className='flex justify-between items-center'>
                <p className='text-brown-50'>MOTOR RENEWAL REPORT</p>
